  ...
  return (
    <>
      <p>
        ...
        importarle. Constitución es de los barrios más transitados. Miles de
        personas llegan hasta ahí desde distintos puntos del conurbano sur para
        comenzar el día laboral en la capital, la ciudad más rica del país. La
        autopista, que corre en paralelo a la avenida San Juan, separa dos
        mundos y aparece como un umbral. Hacia el norte, por avenida
        Independencia, la facultad de Ciencias Sociales de la UBA, la
        Universidad Argentina de la Empresa (UADE) y el Correo Argentino (y
        otros locales de concurrencia), tiñen el aire de un tamiz institucional
        y protegido. Allí el tránsito de gente parece seguro, cuidado por un
        frenesí social. Pero hacia el sur de la autopista, para el lado de la
      ...
      <h6 className={styles.span}>
        ...
        propietarias pero que tampoco cumplen con los requisitos mínimos para
        pagar el alquiler mensual de una vivienda. La mayoría vive en hoteles
        familiares, como esos que abundan en Constitución.
      </h6>
      ...
      <p>
        ...
        dicen que hasta que la gente no esté en la calle no le pueden dar el
        subsidio – explica- y entonces, en vez de evitar que la gente termine en
      ...
      <p>
        ...
        y su revalorización para la especulación está a la orden del día.
      ...
      <h6 className={styles.span}>
        ...
        cantidad de personas situación de calle son los famosos “paradores” o
        Centros de Inclusión Social, de los cuales la propia gente se escapa por
        sus malas condiciones y sus lógicas “de penal” más que de
        acompañamiento.{" "}
      </h6>
      ...
      <p>
        ...
        de vulnerabilidad, es necesario que entregue al GCBA una fotocopia del
        DNI del dueño del hotel. Los dueños de los hoteles dispuestos a dar esa
      ...
      <p>
        ...
        el encargado del hotel para asegurarse de que realmente esté viviendo
      ...
      <h6 className={styles.span}>
        ...
        al recibo que acredita el hotel en el que vive, es necesario que
        entregue al GCBA una fotocopia del DNI del dueño del hotel. Los dueños
        de los hoteles dispuestos a dar esa información son contados con los
        dedos de las manos.
      </h6>
      ...
      <p>
        ...
        trabajo: venta, corte, consumo, cocina y banco de cocaína. El inmueble,
        al mismo tiempo, albergaba como vivienda a una cantidad incontable de
        personas: madres solas con sus hijos, gente por fuera de las lógicas del
      ...
      <p>
        ...
        ganado en la comisaría, aunque, al igual que los restantes vendedores,
        conoció el encierro solo por una noche. La fiscalía ordenó su libertad a
        pocas horas de ser detenido. Me muestra el expediente de su causa donde
        se lo ve en fotos, en la puerta del hotel. También aparecen imágenes de
        50 bolsas de 1 gramo de cocaína (con un valor de mil pesos cada una) y
        fotos de billetes arrugados de 20 pesos que tenía al momento de la
        detención. El resto de la plata, cuenta, estaba dividida: una parte en
      ...
      <h6 className={styles.span}>
        ...
        utilizaba un hotel ubicado en la calle Santiago del Estero al 1200
        (donde también vivía) como base de operaciones logísticas para su
        trabajo: venta, corte, consumo, cocina y banco de cocaína.
      </h6>
      ...
      <p>
        ...
        fantasmas. Algunas averiguaciones muestran que los propietarios fueron,
        mayormente, migrantes italianos o españoles que al morir dejaron
        desocupados los inmuebles, usufructuados luego de diversas formas. Según
        los datos recabados por el Mapa de la Policía entre inquilinos y vecinos
        del barrio, ante la figura abstracta de los propietarios, emergen otros
        protagonistas: los encargados. Ellos son responsables del mantenimiento
        del lugar, pero también tienen la potestad de decidir el precio que se
        abona por el alquiler de una pieza o por el tiempo de permanencia. Son
        capaces de mediar en los conflictos que se den al interior, pueden
        permitir el ingreso a su antojo como el desalojo. En algunos casos,
      ...
      <p>
        ...
        juntos, ella tenía 40, pelo negro, tez blanca y desde los 35 había
      ...
      <p>
        ...
        Las habitaciones se caían a pedazos y se incendiaban cada dos por tres
        ...
        algo que volvía a estar roto al día siguiente porque nadie cuidaba nada.
        El encargado lo despertaba a cualquier hora y lo tenía de “acá para
        allá”. La gota que rebalsó el vaso fue cuando le exigió que fuera él
        quien desalojara a la gente. Lo forzaron a entrar en la habitación de
      ...
      <h6 className={styles.span}>
        ...
        protagonistas: los encargados. Ellos son responsables del mantenimiento
        del lugar, pero también tienen la potestad de decidir el precio que se
        abona por el alquiler de una pieza o por el tiempo de permanencia.
      </h6>
      ...
      <p>
        ...
        larga escalera hasta llegar a la primera esquina en la calle San José,
        casi debajo de la autopista. Era la primera vez que la habitación donde
        vivía se prendía fuego, aunque no era el primer hotel del barrio en el
        cual había vivido. Su vida lleva unos duros 42 años de los cuáles 11,
        los pasó privado de su libertad. Estaba cansado de la estigmatización,
        la marginalidad, la injusticia y el narcotráfico que le había quitado
        gran parte de su vida. Por eso –dice- desde que llegó al hotel de
        puertas verdes a mitad de la calle que acompaña en paralelo a la
        autopista, se ganó más enemigos que amigos. “Sabes que yo no compro con
        los narcos y ellos se sentían mal conmigo porque no podían someterme a
        sus caprichos de superioridad, yo creo que ellos, cuando estaba en la
        ducha, me tiraron algo dentro de la habitación. En ese mismo piso vivían
        también muchos de los que vendían cocaína y derivados, (se había peleado
      ...
      <p>
        ...
        tuvo que escaparse), hay un anexo. Cuando A. llegó a hacer la denuncia
        al día siguiente (la noche la pasó en el hospital a causa del humo
      ...
      <p>
        ...
        porque a la policía –y a nadie más- le interesó indagar sobre aquello.
        A. tampoco podrá recuperar sus pertenencias pero de algo está seguro: el
      ...
      <h6 className={styles.span}>
        ...
        en el hospital a causa del humo inhalado), la policía no quiso tomarle
        declaración. Le dijo que el responsable no se encontraba y que tampoco
        había testigos de lo sucedido.
      </h6>
      ...
      <p>
        ...
        emergente en materia habitacional. No solamente el GCBA los ha utilizado
      ...
      <p>
        ...
        las habitaciones mugrientas de 2x2 y, al menos, 10 jóvenes más durmiendo
        en camas cuchetas. Duró menos de 2 meses, dice Flavia. Desapareció entre
      ...
      <p>
        ...
        mencionada Susana Slamovich, coordinadora del programa para el que ella
        trabajaba. El programa duró un tiempo corto y cuando fue dado de baja,
      ...
      <p>
        ...
        legales o ilegales- se proponen diversificar su uso, más allá de la
        función residencial, con actividades ilegales que generan mayor
        rentabilidad para quienes regentean el lugar”. Entre los ejemplos,
      ...
      <p>
        ...
        estos inmuebles representan un mercado de piezas en alquiler utilizadas
        indirectamente por el GCBA en medio de una crisis de vivienda que en la
        Ciudad Autónoma se vuelve cada vez más importante y transversal al
        conjunto de la sociedad. Incluso cuando una persona obtiene la ayuda
        económica, el mismo GCBA entrega un listado impreso de los hoteles
        legitimados a trabajar con el subsidio 690, listado que incluye a los
