  ...
  return (
    <>
      <p>
        ...
        es una opción. Algunos de ellos son los Centros de Acceso a la Justicia
      ...
      <p>
        ...
        aproximadamente, dos meses. Muchas de ellas no incluían la pérdida de
        clases, dado que se hicieron durante el fin de semana. Sin embargo, el
        reclamo era unísono: exigían mejoras en la infraestructura escolar y en
        la calidad y cantidad de las viandas escolares suministradas por el
        Estado. Además, rechazaban las prácticas laborales no remunerativas en
      ...
      <p>
        ...
        en Cerámica N° 1, el Colegio Mariano Moreno, la Escuela Superior de
        Educación Artística en Artes Visuales Rogelio Yrurtia, la Escuela de
        Música Juan Pedro Esnaola, la Rodolfo Walsh, la Nicolás Avellaneda, el
        Liceo 5 Pascual Guaglianone, el Osvaldo Pugliese y la Escuela Normal
        Mariano Acosta. Aparte de las medidas de fuerza, otras 15 escuelas
        llevaron a cabo actividades y manifestaciones reclamando iguales
        mejoras. “Luego de multitudinarias asambleas, el Colegio Nacional de
        Buenos Aires se encuentra tomado por esta noche en apoyo y solidaridad
        de los colegios de la CABA, que sufren desidia y persecución política
        luego de las medidas votadas por los estudiantes”, manifestaron desde la
        escuela que depende de la Universidad de Buenos Aires. Asimismo, desde
        la Coordinadora de Estudiantes de Base, organización que agrupa a
        estudiantes de diferentes establecimientos, también justificaron las
        jornadas de lucha: “no podemos cursar en edificios en los que no hay
        agua o en los que se caen los techos, hace cuatros meses se cayó una
        pared en la escuela 8 del distrito escolar 10 y de casualidad no terminó
        en tragedia”, explicaron a la prensa. Lo propio hizo la Escuela Superior
        de Comercio Carlos Pellegrini, también dependiente de la UBA, que en
        asamblea votó tomar el establecimiento en solidaridad con el resto de
      ...
      <p>
        ...
        Estado porteño. Es que la ministra, asimismo, presionaba a las
        autoridades de los establecimientos educativos para que procedieran a
        aplicar el protocolo de intervención antitomas, aprobado a través de la
        Resolución 643/MEGC/18 del 14 de febrero de 2018. Dicha norma ordena a
        los directivos de los colegios labrar un acta y enviarla a la máxima
      ...
      <p>
        ...
        pasar por alto que los/as estudiantes son mayoritariamente menores de
        edad, que no pueden ser detenidos/as ni imputados por supuestas
        contravenciones. Por ello, la presencia policial en la puerta de los
        establecimientos sólo persigue un efecto intimidatorio y amenazante para
        que los/as estudiantes, legalmente organizados en los términos de las
        leyes nº 26.877 de la Nación y 137 de la CABA cesen con el ejercicio del
        derecho de petición a las autoridades”, expuso el organismo en un
        comunicado. En igual sentido, las Madres de Plaza de Mayo Taty Almeida y
        Nora Cortiñas, junto a una extensa lista de referentes y organizaciones
        vinculadas a los derechos humanos, dio a conocer un comunicado donde
        expresaban “No es con el Código Penal, ni las amenazas contra los
        golpeados presupuestos familiares que van a resolver los reclamos de
        larga data del movimiento estudiantil, sino gestionando políticamente
        estas demandas y abriendo espacios de diálogo y consenso con les
        adolescentes”. El documento señaló que “el ejercicio de un derecho no
      ...
      <p>
        ...
        paseaba por los pasillos del colegio. “Vino la policía, estuvo dando
        vueltas por la puerta y charlaban con gente de civil. Nosotros
      ...
      <p>
        ...
        las jornadas de lucha, quienes no quisieron prestar testimonio. “Algunos
        padres trabajan en el sector público de la Ciudad y temen alguna
        represalia si hablan”, comentó uno de ellos. Tampoco se obtuvo respuesta
        del Ministerio de Educación de la Ciudad. Lo único que este medio pudo
        saber es que un grupo de padres planea “demandar al Estado porteño” por
        los apercibimientos que realizaron contra ellos. Y que el hermetismo que
      ...
      <p>
        ...
        vigilia afuera del edificio, al cuidado de los adolescentes. No vio a
        nadie, pero sabía que lo habían seguido. El colegio no está cerca de su
        casa. Esa mañana del mes de septiembre del 2022, Julio fue a trabajar
        sin saber que las consecuencias de su apoyo al reclamo del Centro de
        Estudiantes recién comenzaban. El 28 de septiembre, Julio Pasquarelli
        dio un discurso en la puerta de la escuela que se viralizó a través de
        un video en las redes sociales. Allí, el vicerrector mostró su apoyo a
      ...
      <p>
        ...
        a la escuela” para comprenderla. Es curioso, por esa institución pasaron
        desde Enrique Santos Discépolo, Julio Cortázar y hasta el cantante de
      ...
      <p>
        ...
        me está acusando, el que me está castigando? ¿Hay un adoctrinamiento
        malo y otro bueno? Bueno, parecería que sí. Desde principios de 2022
        ─antes de las tomas─, la escuela Mariano Acosta viene con graves
        problemas de infraestructura. Una ventana, cuenta Julio, por poco
        lastima a un maestro en el aula cuando quiso abrirla. Las puertas se
        caen. Las calderas no funcionan en invierno, los techos se llueven. Por
      ...
      <p>
        ...
        esta ciudad, pero parece que eso no importa. En 1999 la institución del
        barrio Monserrat fue declarada monumento histórico. Su estructura fue
        diagramada por el mismo arquitecto que ideó el Teatro Colón. Sin
        embargo, dice Julio, la última vez que se arregló algo de forma
      ...
      <h6 className={styles.span}>
        ...
        tenía ninguna notificación. Yo decía: ¿no me está adoctrinando el que me
      ...
      <p>
        ...
        que el lunes se desarrollaran clases normales, se cortó la luz. Julio,
        que se encontraba en la rectoría firmando unas actas, se comunicó con la
      ...
      <p>
        ...
        alumnos desde afuera del edificio. Cuando volvió a su casa, en la
        ventanilla de su auto, encontró una nota. Lo habían amenazado.
        Finalmente, por intermedio de uno de los padres de los alumnos, la
        Defensoría del Pueblo de la Ciudad mandó a un especialista y devolvió la
      ...
      <p>
        ...
        el país. La ministra de Educación porteña, Soledad Acuña, asistió a ese
        encuentro como invitada y, luego de que le consultaran por los
        conflictos actuales en la escuela, fue tajante: “Gran parte del
        conflicto de la degradación de la educación es el populismo educativo”,
        explicó. “Es el haber creído que cantidad podía reemplazar a la calidad.
        El haber entendido mal el concepto de equidad. Si todos tenían que estar
        adentro, teníamos que dejar de exigir y evaluar. Parte de esa
      ...
      <p>
        ...
        crisis de valores. Hay que recuperar el valor del esfuerzo y la palabra
        mérito”, concluyó la funcionaria del PRO. La mirada de Acuña hacia la
        educación se traduce en el diseño e implementación de políticas que
        tienen un claro tinte represivo: las amenazas de denuncias penales y
        civiles hacia el estudiantado y sus padres, ninguna de las cuales
        pudieron ser comprobadas por este medio; el sumario y las denuncias,
        supuestamente, iniciadas contra el vicerrector Pasquarelli –ninguna de
        las cuales les fue efectivamente notificada- y el uso de la policía de
        la Ciudad como instrumento de notificación y forma de amedrentamiento a
        las familias involucradas. Ante la inminencia del fin del año escolar
        2022, el levantamiento de las medidas de fuerza en las escuelas fue
      ...
      <p>
        ...
        cambios significativos”, cuenta a la prensa Ludmila Tassi, vocera del
        centro de estudiantes del colegio Mariano Acosta. Ante un nuevo año
