  ...
  return (
    <>
      <p>
        ...
        noche. Al hombre lo rodean cinco agentes entre los que hay también
        oficiales de prevención de CABA. A Cristian, ese hombre, lo arrastran
        hacia la vereda y ahora grita en el piso que está golpeado, que le
        lastimaron el brazo y el pie. La pregunta del oficial no es inocente,
        busca neutralizar la intervención. No hay ninguna ley que prohíba grabar
      ...
      <p>
        ...
        Desarrollo Humano y Hábitat de la ciudad de Buenos Aires llevó a cabo,
        de madrugada, un operativo que consistió en bloquear el acceso al predio
        a todo aquel que no tuviera ticket de viaje o fuera empleado del lugar.
        La acción del gobierno porteño se cumplió con la plena colaboración de
        la Policía de Seguridad Aeroportuaria (PSA) que depende del ministerio
        de Seguridad de la Nación, el Organismo Regulador del Sistema Nacional
        de Aeropuertos (Orsna) y la concesionaria Aeropuertos Argentina 2000.
        Quienes habían salido a fumar, trabajar o hacer una compra no tuvieron
      ...
      <p>
        ...
        Buenos Aires- de darles una opción de alojamiento. “Dentro del
        aeropuerto salió todo prolijo y no tuvimos quejas. Con respecto a las
        pertenencias, no estaba enterado porque nosotros no nos ocupamos de la
        limpieza del lugar”, expresó. La versión oficial fue que el personal del
        Buenos Aires Presente (BAP) ofreció el traslado y la posibilidad de ir a
      ...
      <h6 className={styles.span}>
        ...
        la ciudad de Buenos Aires llevó a cabo, de madrugada, un operativo que
        consistió en bloquear el acceso al predio del Aeroparque a todo aquel
        que no tuviera ticket de viaje o fuera empleado del lugar.
      </h6>
      ...
      <p>
        ...
        censo nacional 2022, realizado por el Instituto Nacional de Estadísticas
        y Censos (Indec), surge que de 46.044.703 de habitantes que existen en
        el país, 2.962 duermen en el espacio público. De ellos, 1.864 están en
        la Ciudad y en la provincia de Buenos Aires. Los datos oficiales del
        Indec ni siquiera se acercan al relevamiento censal realizado por el
        gobierno porteño ese mismo año, que registra -solo en la Capital- 2.611
        personas en situación de calle. Estas incongruencias oficiales en las
        estadísticas, además, pueden analizarse a la luz de los fuertes
        cuestionamientos que realizan quienes se dedican voluntariamente a la
        asistencia de esta parte de la población. La metodología de conteo,
        señalan, tiene graves falencias: por ejemplo, el número del Indec
        registra 273.883 personas alojadas en “viviendas colectivas”. Y en ese
        rubro se abarca a los paradores o centros de inclusión, que tienen
        lógicas de estadía temporal y que no constituyen espacios de residencia
        permanente. Si bien en 2023, el registro censal de la ciudad de Buenos
        Aires marcó un aumento del 34% de quienes habitan el espacio público
      ...
      <p>
        ...
        abril de 2023 a pesar de haber sido aprobada a fines de 2021. Lo que
        motivó el apuro en publicar el decreto fue la muerte de una beba de tres
        meses en contexto de extrema urgencia habitacional. Dormía junto a sus
      ...
      <p>
        ...
        techo están en la vía pública, a la vista de todos pero las plataformas
        políticas casi no proponen un abordaje integral de la situación. Esas
        tendencias tienen el aval de las mayorías y se confirman cada vez que
      ...
      <h6 className={styles.span}>
        ...
        un aumento del 34% de quienes habitan el espacio público respecto del
        año anterior (3.511 personas), el número dista mucho de acercarse a las
        7.251 personas que, ya en 2019, reportaba el Censo Popular de Personas
      ...
      <p>
        ...
        universidades-; aquellos de gestión exclusiva del gobierno porteño y
        otros destinados de manera especial a personas con discapacidades. Estos
        centros, según consta en la web, cubren necesidades inmediatas como
        alojamiento, alimentación e higiene. Las personas que acuden allí
        reciben orientación para la gestión de trámites, asistencia médica y
        actividades culturales, recreativas y de reinserción sociolaboral. Pero
        el relato está en disputa y, en este caso, la información relevada por
        las organizaciones es opuesta. “Les cambiaron el nombre para que
        parezcan otra cosa, pero me cuesta no llamarlos ‘paradores’ porque las
        condiciones no variaron”, dice la voluntaria y presidenta de Amigos en
        el Camino, Mónica De Russis en diálogo con el Mapa de la Policía. “No
        ...
        ofrecen ir a los que más lindos dejaron. Después tienen otros que son
        conveniados o propios pero con lógicas muy perversas”, asegura Guido
      ...
      <h6 className={styles.span}>
        ...
        llamarlos ‘paradores’ porque las condiciones no variaron”, dice la
        voluntaria y presidenta de Amigos en el Camino, Mónica De Russis.
      </h6>
      ...
      <p>
        ...
        activistas Milena Sapey, Luciana Armentano y Jorgelina Di Iorio de la
      ...
      <p>
        ...
        testimonios de las personas en situación de calle coinciden en que la
      ...
      <p>
        ...
        invertir alrededor de 1526 millones de pesos en un relevamiento de “las
        condiciones que impactan en la higiene urbana en la vía pública de la
        Ciudad”. En el texto de la licitación N° 7162-1862 LPU22, el ministerio
        de Espacio Público e Higiene Urbana solicitaba, entre otras cosas, la
        “verificación ocular de recuperadores urbanos” y la “susceptibilidad de
        producir contaminación visual”. Se equiparaba la presencia de cartoneros
        e indigentes con “residuos domiciliarios, de comercios e industriales,
      ...
      <p>
        ...
        Ciudad, la mayoría de las veces de madrugada, con camiones de basura en
        los que arrojan las pertenencias de los vecinos sin techo. En algunas
        ocasiones, con el auxilio de la policía de la Ciudad. Se trata de lo
        que, comúnmente, se conoce como desplazamientos forzados, con episodios
        de violencia, robos de pertenencias y mediados por malos tratos verbales
        y/o físicos. “No nos dieron tiempo a nada y vimos cómo todas nuestras
        cosas se iban por la trituradora”, cuenta uno de los damnificados en una
        publicación de las redes sociales de la Asamblea Popular de Personas en
        Situación de Calle, donde a menudo se comparten fotos, videos y relatos
      ...
      <p>
        ...
        Jorge Macri, como su compañera de fórmula en las elecciones locales. El
        pasado 1 de junio, el candidato prometió en una entrevista en Radio La
        Red “recuperar el afuera para el vecino” ocupado por personas en
        situación de calle: “Hoy los cajeros automáticos se han transformados en
        los monoambientes de algunos”, expresó. A menos de un mes de los
        comicios, mientras se producía este informe, la ministra Muzzio tenía la
        agenda cerrada a notas periodísticas, pero el Mapa de la Policía pudo
        conversar con sus colaboradores acerca de los registros audiovisuales y
        denuncias de desplazamientos forzados. “Cuando quienes dependen del
        Ministerio tienen que hacer un operativo de higiene y hay alguien en
        situación de calle en el lugar, siempre se llama a Buenos Aires Presente
        (BAP). Cualquier resolución que se tome es a raíz de lo que ellos
        definan”, dijeron. Al preguntarles si estaban enterados de las denuncias
        públicas realizadas por las organizaciones sociales, negaron que les
        hayan llegado reportes por parte de las empresas de limpieza
        tercerizadas con las cuales la Ciudad trabaja en el territorio porteño.
        “Puede pasar que cuando van a un lugar y no hay nadie, se lleven los
        objetos voluminosos que haya, pero en esos videos no se ve el contexto,
      ...
      <p>
        ...
        desplazamiento forzado. Solo basta mencionar que a solo un mes y medio
        después de las declaraciones radiales de Jorge Macri, legisladores de su
        espacio político impulsaron y obtuvieron la media sanción en la Cámara
        de Diputados de una modificación en la Ley de Alquileres vigente que,
        con achicamiento del plazo de ajuste y beneficios para los propietarios
      ...
      <h6 className={styles.span}>
        ...
        los operativos de “limpieza”, es Clara Muzzio. La funcionaria, además,
        fue elegida por el candidato a jefe de Gobierno de Juntos por el Cambio,
        Jorge Macri, como su compañera de fórmula en las elecciones locales.
      </h6>
      ...
      <p>
        ...
        Fabián Pepín Rodríguez Simón y a otros integrantes del organismo por las
        acusaciones de violencia organizada y sistemática hacia las personas en
        situación de calle. Finalmente, el organismo se disolvió a fines de 2009
        tras difundirse los testimonios que daban cuenta de que dicha Unidad
      ...
      <p>
        ...
        exista ninguna fuerza paraestatal. Sí diría que la Ucep, en su momento,
        se creó por decreto, pero se constituyó a partir de convocar a
        barrabravas y matones”, explicó. Luego, detalló: “Era altamente
        anticonstitucional porque hablaba de remover personas y según el
      ...
      <p>
        ...
        nocturnos violentos, traslados en camionetas no identificadas hacia
        otras provincias y amenazas. En este sentido, la diferencia con la
        actualidad es que no existe el mismo nivel de organización y
        clandestinidad. Hoy, quienes llevan a cabo las tareas de “remoción” y
      ...
      <p>
        ...
        hoy es señalado como el que ejerce violencia institucional hacia quienes
        no tienen dónde vivir. “Los mayores casos para observar la continuidad
        informal de esta dinámica hay que buscarlos en esa cartera”, advirtió
