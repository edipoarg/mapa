...
const TodasInvestigaciones = () => {
    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          const response = await fetch('../src/components/investigaciones/investigaciones.json');
    ...
    return (
      <div className={styles.todasContainer}>
        {investigaciones.map((investigacion) => (
          ...
          >
            <section
              className={`${styles.investigacionContainer} `}
            >
              <img
            ...
            <section className={styles.dataContainer}>
              <h2 className={styles.tituloInvestigacion}>{investigacion.titulo}</h2>
