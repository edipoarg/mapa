...
const Denuncia = () => {
  ...
  const [identificacion, setIdentificacion] = useState('Especifícanos cuál fue');
...
<select value={agresor} onChange={(e) => setAgresor(e.target.value)}>
  ...
  <option value="(DOU) Operaciones Urbanas de Contención">(DOU) Operaciones Urbanas de Contención</option>
  <option value="Agentes de Prevención CABA">Agentes de Prevención CABA</option>
  ...
  <option value="De Civil (sin uniforme)">De Civil (sin uniforme)</option>
...
/>
          ...
          <label>
            <input type="checkbox" checked={visibilizar} onChange={() => setVisibilizar(!visibilizar)} />
          ...
          <div>
            ...
            <input type="checkbox" checked={aceptoTerminos} onChange={() => setAceptoTerminos(!aceptoTerminos)} />
          </div>
